...
$(document).on('wb-signup-success', function (e, el, err) {
    if (err !== undefined && err.signup == true) {
        $('.alert.signup-success').removeClass('d-none');
        //wbapp.toast(wbapp._settings.sysmsg.error, err, { target: '.content-toasts', 'bgcolor': 'warning', 'txcolor': 'white' });
    }
});

$(document).on('wb-signup-error', function (e, el, err) {
    if (err !== undefined && err.signup == false) {
        $('.alert.signup-error').removeClass('d-none');
        //wbapp.toast(wbapp._settings.sysmsg.error, err, { target: '.content-toasts', 'bgcolor': 'warning', 'txcolor': 'white' });
    }
});
