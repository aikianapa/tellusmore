...
<body class="app-chat">
    <div class="app-chat" wb-disallow="user">
        <div class="container">
        ...
        <aside class="aside aside-fixed">
            <div class="aside-header">
                <a href="#" class="aside-logo"
                    data-ajax="{'url':'/cms/ajax/form/drivers/list','html':'.content-body'}" auto>
            ...
            <div class="aside-body ps">
                <ul class="nav nav-aside">
                    ...
                    <li class="nav-item">
                        <a href="#" data-ajax="{'url':'/cms/ajax/form/drivers/list','html':'.content-body'}"
                            class="nav-link">
                            <svg class="mi mi-car" wb-module="myicons"></svg>
                            <span>Водители</span>
                        </a>
                    </li>
                    <li class="nav-item">
